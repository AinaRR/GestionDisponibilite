...
namespace GestionDisponibilite.Migrations
{
    ...
    [Migration("20250519072224_UpdateAdminHash")]
            ...
            modelBuilder.Entity("GestionDisponibilite.Model.Employe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nom = "Admin",
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$oQExXTxSIxHdeKDOPQ8BRw$ErAHwLsb6FQuoHq1Cso9O/6E+sH8I+CElgJ5bSSyJVU",
                            Prenom = "Root",
                            Role = "Admin",
                            SurProjet = false,
                            Telephone = "",
                        ...
                        new
                        {
                            ...
                            Nom = "User",
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$mFAtwBa33jlTRNAiYSOFLw$hYA1SEtIKZbg3VVOVR4Iu8tWohqDJJBgbAJMJCuN5fQ",
                            Prenom = "Normal",
                            Role = "User",
                            SurProjet = false,
                            Telephone = "",
