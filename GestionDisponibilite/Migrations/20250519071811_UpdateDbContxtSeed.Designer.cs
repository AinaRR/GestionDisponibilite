...
namespace GestionDisponibilite.Migrations
{
    ...
    [Migration("20250519071811_UpdateDbContxtSeed")]
    partial class UpdateDbContxtSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestionDisponibilite.Model.Employe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nom = "Admin",
                            PasswordHash = "$argon2id$v=19$m=65536,t=2,p=1$wphGkXZ...$h1De6k...",
                            Prenom = "Root",
                            Role = "Admin",
                            SurProjet = false,
                            Telephone = "",
                        ...
                        new
                        {
                            ...
                            Nom = "User",
                            PasswordHash = "$argon2id$v=19$m=65536,t=2,p=1$yU4n2B...$pAn8eF...",
                            Prenom = "Normal",
                            Role = "User",
                            SurProjet = false,
                            Telephone = "",
