...
namespace GestionDisponibilite.Migrations
{
    ...
    [Migration("20250519095602_UpdateAuthService")]
    partial class UpdateAuthService
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestionDisponibilite.Model.Employe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nom = "Admin",
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$tpG/7isxBJ06i0MVrRbGgA$cha1m6d9Wq4eWmcMGb8RI4AE5z5OzSOvo2sEKp16Ijc",
                            Prenom = "Root",
                            Role = "Admin",
                            SurProjet = false,
                            Telephone = "",
                        ...
                        new
                        {
                            ...
                            Nom = "User",
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$WbjTHZkWSgSi0JMlks/Tng$+pvElrz3TDDWH4keEBGYhkGcE51EJyKtAx+DJGL5w+o",
                            Prenom = "Normal",
                            Role = "User",
                            SurProjet = false,
                            Telephone = "",
