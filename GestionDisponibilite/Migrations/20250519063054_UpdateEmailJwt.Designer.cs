...
namespace GestionDisponibilite.Migrations
{
    ...
    [Migration("20250519063054_UpdateEmailJwt")]
    partial class UpdateEmailJwt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GestionDisponibilite.Model.Employe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nom = "Admin",
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$ZcE0oy8dHYwbICElw9RRkA$KlHjulvBVkJSdLzDb/p9UFNrp6y4GZFt+djoXmOwkfk",
                            Prenom = "Root",
                            Role = "Admin",
                            SurProjet = false,
                            Telephone = "",
                        ...
                        new
                        {
                            ...
                            Nom = "User",
                            PasswordHash = "$argon2id$v=19$m=65536,t=3,p=1$oUItr0YLSB+enmGNoskL8Q$Qg+Uf7Hf6enIQJFpRdWjquO+x43UILqIKdQGpG99fqk",
                            Prenom = "Normal",
                            Role = "User",
                            SurProjet = false,
                            Telephone = "",
